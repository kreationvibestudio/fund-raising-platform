/**
 * Official campaign manifesto — edit the strings below with your final text.
 * This copy is shown between the hero (impact) and the donor wall / donation form
 * so supporters read conviction right before they give.
 */
export const manifesto = {
  kicker: "Our manifesto",
  title: "A pledge to Esan North East & South East",
  subtitle:
  ...
  pledges: [
    "People-first representation, not politics for its own sake.",
    "Visible results and honest reporting back to the constituency.",
    "Youth and women at the centre of opportunity and inclusion.",
    "Zero tolerance for the silence that leaves our communities behind.",
  ],
  /** One line that emotionally hands the reader to the donate action. */
  closingLine:
    "When you give today, you do not fund a poster—you fuel a mandate written in the language of service. Stand with us.",
  donateCtaLabel: "Give to this mandate",
} as const;
